...
//		model.addAttribute("attendanceList",resultList);
	 ...
	 * // 출근 페이지
	 * 
	 * @GetMapping("/checkinout") public String checkInOut() { return "checkinout";
	 * }
	 */
	 ...
	 * @PostMapping("/log")
	 * 
	 * @ResponseBody public Map<String,String> recordAttendance(AttendanceDto dto){
	 * Map<String,String> resultMap = new HashMap<String,String>();
	 * resultMap.put("res_code", "500"); resultMap.put("res_msg", "처리에 실패했습니다.");
	 * 
	 * Attendance result = attendanceService.recordAttendance(dto); if(result !=
	 * null) { resultMap.put("res_code", "200"); resultMap.put("res_msg",
	 * "checkIn".equals(dto.getAttendanceType()) ? "출근 완료! 오늘도 힘내세요~" :
	 * "퇴근 완료! 수고하셨습니다"); }
	 * 
	 * return resultMap; }
	 */
